...
import chapeu from "../assets/chapeu-cowboy.jpg";
  ...
  return (
    ...
    >
      ...
      <img
        src={chapeu}
        alt="Chapéu cowboy"
        className="mx-auto mb-4 h-24 w-auto select-none"
      />
      <p
      ...
      <p className="mt-1 mb-0 font-[Fredoka] text-[26px] font-bold text-[#7c451f]">
        a família do Arthur
      </p>
