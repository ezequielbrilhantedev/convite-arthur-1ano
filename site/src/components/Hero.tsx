...
import { CowboyToy } from './CowboyToy';
...
export function Hero({ countdown }: { countdown: Countdown }) {
  return (
    <section
      ...
      style={{ background: 'linear-gradient(#3f8fd0 0%, #6bb2e4 55%, #9ed4f0 100%)' }}
    >
      {/* sun */}
      <div
      ...
      <Star size={11} style={{ top: 88, right: 96 }} duration="3.1s" delay="0.5s" />
      <Star size={13} style={{ top: 150, left: 30 }} duration="2.7s" delay="0.9s" />
      <Star size={10} style={{ top: 200, right: 30 }} duration="3.5s" delay="0.3s" />
      ...
      <div className="relative pt-[14px] text-center">
        <div
          ...
          style={{ background: '#e0503a', boxShadow: '0 4px 0 #a83322', animation: 'rise .6s ease both' }}
        >
          Você foi convidado
        </div>
        ...
        <p
          ...
          style={{ textShadow: '0 2px 6px rgba(0,0,0,.28)', animation: 'rise .6s ease .2s both' }}
        >
      ...
      <div className="relative mt-[14px] h-[250px]">
        ...
        >
          <div
            ...
            style={{
              background: 'radial-gradient(circle at 32% 30%, #f4b93b, #d98b2b)',
        ...
        {/* rocket */}
        <div className="absolute top-2 left-[6px] origin-top-left" style={{ transform: 'scale(.78)' }}>
            ...
            <div className="relative" style={{ width: 84, height: 133 }}>
              ...
              <div
                ...
                style={{
                  ...
                  width: 22,
                  height: 22,
                  background: 'radial-gradient(circle at 35% 35%, #8fd0f2, #3f8fd0)',
                  border: '3px solid #7c451f',
                }}
              />
              <div
                className="absolute left-1/2 top-[74px]"
                style={{ transform: 'translateX(-50%)', width: 44, height: 12, background: '#f4b93b' }}
              />
              <div
              ...
              <div
                ...
                style={{
                  ...
                  width: 20,
                  height: 26,
                  background: 'radial-gradient(circle at 50% 20%, #ffd766, #f4b93b)',
        ...
        <div className="grid grid-cols-4 gap-[9px]">
          {CELL_LABELS.map(([key, label]) => (
            <div
              ...
              style={{ background: '#7c451f', border: '3px solid #5c3315', boxShadow: '0 5px 0 #4a2810' }}
            >
